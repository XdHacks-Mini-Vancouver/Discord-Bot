...
function updateTime(){
  setInterval(() => {
    if(moment().format('MMMM Do YYYY, h:mm:ss a') === "August 6th 2021, 6:50:00 pm"){
      exampleEmbed
      .setTitle('💁🏻‍♂️Join us for our Official Opening Ceremony!')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️HTML/CSS Programming Basics')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Introduction to JavaScript - Building a game')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Discord Bot Programming Basics')
      .setURL(null) 
    ...
    //Do SATURDAY August 7th
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Programming Languages and choosing one')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Build Responsive Web Apps with React')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️EchoAR Workshop: Build a Cloud-Connected AR/VR App in 15 Minutes or Less')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Protips for Joining the Video Game Industry')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Brief overview of websites and their vulnerabilities Part 1')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Tips and tricks for jump-starting your career')
      .setURL(null) 
    ...
    //start
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Flow States Workshop')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Making Money with Affiliate Marketing')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Brief overview of websites and their vulnerabilities Part 2')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Special Speaker #3: Berkeley SWE Organization')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Live Pitching Schedule Released')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️University Programs with regard to STEM')
      .setURL(null) 
      ...
      exampleEmbed
      .setTitle('💁🏻‍♂️Resume Building and Cover Letters')
      .setURL(null) 
