...
const date2 = new Date('7/15/2021, 2:02:00 PM')
var pstDate2 = date2.toLocaleString("en-US", {timeZone: "America/Los_Angeles"})

let offSet = pstDate - pstDate2
client.once('ready', () => {
  console.log("Bot is online!")

  setTimeout(console.log("Hi"), offSet)
