...
function updateTime(){
  setInterval(() => {
    if(moment().format('MMMM Do YYYY, h:mm:ss a') === "July 16th 2021, 9:13:00 pm"){
      exampleEmbed
      .setTitle('💁🏻‍♂️Join us for our Official Opening Ceremony!')
      .setURL(null) 
      .setDescription('<@&859593630217011211> Welcome to Climate Code 2021! Important information will be shared, rules will be reviewed, submissions, prizes, sponsors, packages, and a special guest! \n \n **📆Date&Time: ** Friday, August 6th 2021 @ 7:00PM \n \n **📢Name of workshop: ** Opening Ceremony \n\n **🗣Speaker(s): ** XdHacks Mini Vancouver Team \n\n **🌠Location: ** Zoom (link: ----) ')
